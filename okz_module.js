...
function ObslugaKlopotliwychZnizek() {
         ...
         var BEZ_ZNIZKI = 1;
         var KLOPOTLIWE_ZNIZKI = {INTERNOWANI:63, KOMBATANCI:67, WETERANI:85, WETERANI_74: 74 , CYWILNA_OFIARA: 87, KOMBATANT_INWALIDA: 83, INWALIDZI_WOJENNI_WOJSKOWI:82};     
         ...
         function validate(inputRef) {
            ...
            }/*else if(ZakupBiletuUtil().czyWybranoZnizkiKolejarzaPolbus()) {
          ...
          function pokazLiczbeNOrazZnizke() {
              ...
              $("#liczba_u_2_1").show();
              $("#liczba_u_2").addClass("przesiadka_hide_elem");
              $("#liczba_u_2_2").show();
              $("#liczba_u_3").addClass("przesiadka_hide_elem");
              $("#liczba_u_2_3").show();
          ...
          function isZaznaczonoKlopotliwaZnizke() {
              ...
              var znizka_arr = ["kod_znizki", "kod_znizki_2", "kod_znizki_3"];                    
              var klopotliwe_znizki_arr = [KLOPOTLIWE_ZNIZKI.KOMBATANCI, KLOPOTLIWE_ZNIZKI.WETERANI, KLOPOTLIWE_ZNIZKI.WETERANI_74, KLOPOTLIWE_ZNIZKI.CYWILNA_OFIARA];
          ...
          function aktywujPolaDlaDrugiegoOdcinkaDlaKatPoc_TLK_EIP() {
              ...
              if(isPociagKat_TLK_IC_AND_EIP_EIC(katPocOdcinek1, katPocOdcinek2)) {
                  ...
                  if(iloscOsobPierwszyOdc > DEFAULT_VAL) {                      
                      ...
                      if(parseInt($("#liczba_n").find("option:selected").val(), 10) > 0) {
                          $("#tr_liczba_osob_n_2").show();
                      }
